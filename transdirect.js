	...
	if (document.getElementById('to_location').value == '') {
        ...
        jQuery.post(
            ...
            MyAjax.ajaxurl, {
                ...
                'to_type'           : document.getElementById('business').checked ? document.getElementById('business').value : document.getElementById('residential').value,
                'insurance_value'   : document.getElementById('insurance_value') ? document.getElementById('insurance_value').value : 0
            }, function(response) {
